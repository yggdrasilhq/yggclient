...
Options:
  ...
  --ssh-opts "..."           Extra ssh options (example: -i /home/user/.ssh/id_ed25519)
...
Examples:
  ...
  sudo scripts/zfs/shift-sync.sh push --map zroot/ROOT/debian=zroot/lxc/client-a/ROOT/debian --map zroot/home/user=zroot/lxc/client-a/ROOT/home/user
USAGE
}
